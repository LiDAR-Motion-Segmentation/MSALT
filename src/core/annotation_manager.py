...
class AnnotationManager:
    ...
    def save_frame(self, frame_idx: int, boxes_dir: Path, meta_dir: Path, filename: str):
        ...
        for box in boxes:
            ...
            indices_list = box.point_indices.tolist() if box.point_indices is not None else []
